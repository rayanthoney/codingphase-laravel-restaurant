    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
                ...
                {{-- Beginning of The Menu Dashboard --}}
                <li class="nav-item ">
                ...
                {{-- End of The Menu Dashboard --}}

                {{-- Beginning of The UI Menu Elements --}}
                <li class="nav-item">
                ...
                {{-- Beginning of The UI Customers Elements --}}
                <li class="nav-item">
                ...
                {{-- Beginning of The UI Users Elements --}}
                <li class="nav-item">
                ...
                {{-- Beginning of The UI Settings Elements --}}
                <li class="nav-item">
                    ...
                    <div id="submenu-5" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/"> General Settings <span class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                {{-- End of The UI Elements --}}
            </ul>
        </div>
    </nav>
</div>